...
The second component, "Body", would contain a dynamic list of html paragraphs (now the number is fixed in 5 , but not in a real App ), with a basic information of "status of servers".
